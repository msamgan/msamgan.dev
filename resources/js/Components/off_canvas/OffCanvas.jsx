        ...
        >
            ...
            <div className="fixed inset-y-0 right-0 flex max-w-full pl-0 sm:pl-4 md:pl-10">
                <div
                    ...
                    id={id}
                >
                    <div className="flex h-full flex-col overflow-y-auto bg-white shadow-lg rounded-l-2xl">
                        {/* Header */}
                        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-5">
                            ...
                            <button
                                type="button"
                                className="rounded-full p-2 text-gray-400 hover:text-primary hover:bg-gray-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                                onClick={onClose}
                                aria-label="Close"
                            >
